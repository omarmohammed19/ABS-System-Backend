    ...
    async create(register: Register): Promise<Register[]> {
        try {
            ...
            const result = await pool.request()
                ...
                .input("userName", sql.Int, register.userName)
                .input("webUserPassword", sql.NVarChar, register.webUserPassword)
                .input("salesChannelName", sql.Int, register.salesChannelName)
                .input("salesChannelTypeID", sql.Int, register.salesChannelTypeID)
                .input("salesChannelURL", sql.Int, register.salesChannelURL)
                ...
                .input("mobileNumber", sql.Int, register.mobileNumber)
                .input("walletNumber", sql.Int, register.walletNumber)
                .input("walletMobileNumber", sql.Int, register.walletMobileNumber)
                .input("paymentNearestBranchID", sql.Int, register.paymentNearestBranchID)
                .input("accountHolderName", sql.Int, register.accountHolderName)
                .input("accountNumber", sql.Int, register.accountNumber)
                .input("bankNameID", sql.Int, register.bankNameID)
                .input("IBAN", sql.Int, register.IBAN)
                .input("swiftCode", sql.Int, register.swiftCode)
