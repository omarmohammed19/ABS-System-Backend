    ...
    async updatePricePlan(pp: PricePlan): Promise<string> {
        try {
            ...
            const result = await pool.request()
                ...
                .input('fromZoneID', sql.BigInt, pp.fromZoneID)
                .input('toZoneID', sql.BigInt, pp.toZoneID)
                .input('price', sql.Decimal, pp.price)
                .input('pricePlanID', sql.BigInt, pp.pricePlanID)
                .input('numberOfShipments', sql.BigInt, pp.numberOfShipments)
