...
export class ContactNumberTypesController {
  ...
  async deactivate(ID: number): Promise<string> {
    try {
      const result = De_Activate<ContactNumberTypesModel>(ContactNumberTypes, ID, 'deactivate');
      return result;
    } catch (err) {
  ...
  async activate(ID: number): Promise<string> {
    try {
      const result = De_Activate<ContactNumberTypesModel>(ContactNumberTypes, ID, 'activate');
      return result;
    } catch (err) {
