...
export class SalesChannelTypesController {
    ...
    async deactivate(ID: number): Promise<string> {
        try {
            const result = De_Activate<SalesChannelTypesModel>(SalesChannelTypes, ID, 'deactivate');
            return result;
        } catch (err) {
    ...
    async activate(ID: number): Promise<string> {
        try {
            const result = De_Activate<SalesChannelTypesModel>(SalesChannelTypes, ID, 'activate');
            return result;
        } catch (err) {
